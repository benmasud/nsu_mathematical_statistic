...
# Calculate the t-statistic for the 99% confidence level with n-1 degrees of freedom
t_stat = t.ppf(0.995, n - 1)

# Calculate the confidence interval
lower_bound = mean - t_stat * (std_dev / np.sqrt(n))
upper_bound = mean + t_stat * (std_dev / np.sqrt(n))

print("99% Confidence Interval for Population Mean:")

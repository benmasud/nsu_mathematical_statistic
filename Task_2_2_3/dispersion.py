...
# Calculate the chi-squared statistic for the 99% confidence level with n-1 degrees of freedom
chi2_stat_lower = chi2.ppf(0.005, n - 1)
chi2_stat_upper = chi2.ppf(0.995, n - 1)

# Calculate the confidence interval for variance
lower_bound_var = (n - 1) * variance / chi2_stat_upper
upper_bound_var = (n - 1) * variance / chi2_stat_lower

# Calculate the confidence interval for standard deviation
lower_bound_std_dev = np.sqrt(lower_bound_var)
upper_bound_std_dev = np.sqrt(upper_bound_var)

print("99% Confidence Interval for Population Variance:")
print("Lower bound: ", lower_bound_var)
print("Upper bound: ", upper_bound_var)

print("99% Confidence Interval for Population Standard Deviation:")
print("Lower bound: ", lower_bound_std_dev)
print("Upper bound: ", upper_bound_std_dev)
